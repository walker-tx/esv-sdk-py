...
[`EsvError`](./src/esv_sdk/models/esverror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary errors:**
* [`EsvError`](./src/esv_sdk/models/esverror.py): The base class for HTTP error responses.
  * [`Error`](./src/esv_sdk/models/error.py): Bad request.
...
**Inherit from [`EsvError`](./src/esv_sdk/models/esverror.py)**:
* [`ResponseValidationError`](./src/esv_sdk/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
